  ...
  package com.project.saludLegal.config;
   ...
   * Configuración del Swagger para generar documentacion
  ...
  @EnableSwagger2 public class SwaggerConfig extends
  WebMvcConfigurationSupport{
  
  @Bean 
  public Docket apiDocket() { return new
